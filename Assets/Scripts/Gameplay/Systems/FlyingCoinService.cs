...
public class FlyingCoinService : IFixedTickable
{
	...
	private Vector3 targetPosition =>
		_cameraMain.ScreenToWorldPoint(new Vector3(_coinsTarget.coinsTargetTransform.position.x, _coinsTarget.coinsTargetTransform.position.y, _cameraMain.nearClipPlane));
	...
	public FlyingCoinService(FlyingCoinsConfig config, ICoinsTarget coinsTarget) {
		_config = config;
