public class PauseState : State
{
	...
	public PauseState(StateSwitcher stateSwitcher, PauseUiSystem pauseUiSystem, PauseHandler pauseHandler, SceneLoaderService sceneLoaderService) : base(stateSwitcher) {
